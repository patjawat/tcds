...
<table width="100%" style="margin-left:90px;">
    <tr>
        <td width="25%"><?=Html::img(Yii::getAlias('@app/web/img/').'logo-01.png', ['width' => 130])?></td>
        <!-- <td width="33%" align="center">DM ASSESSMENT TODAY</td> -->
        <td width="70%" align="center"><b><?=$title;?></b></td>
        <td width="5%" style="text-align: right;">{PAGENO}/{nbpg}</td>
    </tr>
</table>
        ...
        <td>
            ...
            <table style="margin-left: 2px;font-size: 13px;">
                <tr>
                    ...
                    <td>RECORDER</td>
                    <td><u></td>
                    <td align="right">____________________________________</td>
                </tr>
            </table>
