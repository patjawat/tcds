...
<style>
    .field-sfootassessmentsummaryopd-right_claw_toe {
        display: inline-block;
    }

    .field-sfootassessmentsummaryopd-right_hammer_toe {
        display: inline-block;
    }

    .field-sfootassessmentsummaryopd-right_maillet_toe {
        display: inline-block;
    }

    .field-sfootassessmentsummaryopd-left_claw_toe {
        display: inline-block;
    }

    .field-sfootassessmentsummaryopd-left_hammer_toe {
        display: inline-block;
    }

    .field-sfootassessmentsummaryopd-left_maillet_toe {
        display: inline-block;
    }

    .field-sfootassessmentsummaryopd-right_callus {
        display: inline-block;
    }

    .field-sfootassessmentsummaryopd-right_corn {
        display: inline-block;
    }

    .field-sfootassessmentsummaryopd-left_callus {
        display: inline-block;
    }

    .field-sfootassessmentsummaryopd-left_corn {
        display: inline-block;
    }
...
<?=$this->render('@app/modules_share/foot/views/default/panel_top',[
    ...
    <br>
    <?=$this->render('../default/foot-assessment-summary/summary_top',['opd'=>'active','ipd' => ''])?>

<h4 style="color:#777;text-align: center;">OPD DIABETIC FOOT ASSESSMENT RECORD : SUMMARY</h4>
<?php $form = ActiveForm::begin(['id' => 'form','action' => ['/foot/foot-assessment-summary-opd']]); ?>
...
<table width="1106" border="0" class="table table-bordered">
    ...
    <tr>
        <td>1.<strong> Neuropathy assessment</strong></td>
        <td></td>
        <td></td>
    </tr>
    <tr>
...
<?=$this->render('../default/foot-assessment-summary/summary_footer.php')?>
