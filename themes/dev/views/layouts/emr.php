...
<body style="font-family: 'Kanit', sans-serif;background-color:#efefef;">
    <?php $this->beginBody() ?>
    <?php Modal::begin([
        'id' => 'main-modal',
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?= Url::to(['/site/landing']) ?>"><img src="img\logo-02.png"
                    ...
                    <li>
                        <div style="padding-top: 10px">
                            ...
                            <button type="submit" class="btn btn-default" disabled
                                title='กรุณายกเลิกให้บริการคนปัจจุบัน'><i
                                    class="glyphicon glyphicon-search"></i></button>
                            <?php endif; ?>
                    ...
                    <li style="padding-top: 5px;padding-left: 5px;">
                        <h4>
                            <div id='user-display'>
                                ...
                                <?php else: ?>
                                <?= Html::a(UserHelper::getUser('fullname') ? UserHelper::getUser('fullname') : \Yii::$app->user->identity->username, ['/site/about']) ?>
                                | <span style="color: #ffffff;" id="show-department"></span>
                                <?php endif; ?>
                            </div>
                        </h4>
                    </li>
    ...
    <div style="width: 100%; margin-top: 50px;">
        ...
        <nav class="navbar navbar-default" role="navigation"
            style="margin-left: -1px;background-color: #fff;height: 51px;">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="margin-left:10px;">
                    <?php //$this->render('@app/components/_toolbar'); ?>
                    </ul>
                </div><!-- /.navbar-collapse -->
            </div><!-- /.container-fluid -->
        </nav>
