...
namespace app\modules\dm\controllers;
...
class DefaultController extends Controller
{
    ...
    public function actionForm(){
        ...
        // $title = substr(Yii::$app->request->get('title'), 1,-1);
        ...
        $pdf = new Pdf([
            ...
            'methods' => [
                'SetHeader' => $this->renderPartial('dm_o_header',[
                    'model' => $model,
                    'vs' => $vs,
                    'title' => $title

                ]),
                'SetFooter'=> $this->renderPartial('dm_footer'),
                // 'SetHeader'=>true,
                // 'SetFooter'=>true,
            ],
            'marginLeft' => 10,
