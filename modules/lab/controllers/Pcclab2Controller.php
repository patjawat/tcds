...
use app\modules\lab\models\Pcclab2Search;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * Pcclab2Controller implements the CRUD actions for Pcclab model.
 */
class Pcclab2Controller extends Controller
{
    /**
     * {@inheritdoc}
     */
