...
class PreorderlabSeach extends Preorderlab
{
    ...
    {
        return [
            [['id', 'pcc_vn', 'data_json', 'pcc_start_service_datetime', 'pcc_end_service_datetime', 'data1', 'data2', 'hospcode', 'lab_code', 'lab_name', 'lab_request_date', 'lab_result_date', 'lab_result', 'standard_result', 'lab_code_moph', 'last_update','cid'], 'safe'],
            [['lab_price'], 'number'],
        ];
    }
