...
?>
<style>
#sfootulcerfirstopd-wagner{display: inline-block;}
#sfootulcerfirstopd-ut_grade{display: inline-block;}
#sfootulcerfirstopd-ut_stage{display: inline-block;}
#sfootulcerfirstopd-vessel_palpation_dp_right{display: inline-block;}
#sfootulcerfirstopd-vessel_palpation_pt_right{display: inline-block;}
#sfootulcerfirstopd-vessel_palpation_dp_left{display: inline-block;}
#sfootulcerfirstopd-vessel_palpation_pt_left{display: inline-block;}


.field-sfootulcerfirstopd-abi1_right{display: inline-block;}
.field-sfootulcerfirstopd-abi2_right{display: inline-block;}
.field-sfootulcerfirstopd-abi3_right{display: inline-block;}
.field-sfootulcerfirstopd-abi1_left{display: inline-block;}
.field-sfootulcerfirstopd-abi2_left{display: inline-block;}
.field-sfootulcerfirstopd-abi3_left{display: inline-block;}

.field-sfootulcerfirstopd-tbi1_right{display: inline-block;}
.field-sfootulcerfirstopd-tbi2_right{display: inline-block;}
.field-sfootulcerfirstopd-tbi3_right{display: inline-block;}
.field-sfootulcerfirstopd-tbi1_left{display: inline-block;}
.field-sfootulcerfirstopd-tbi2_left{display: inline-block;}
.field-sfootulcerfirstopd-tbi3_left{display: inline-block;}

.field-sfootulcerfirstopd-post_amputation_type{display: inline-block;}
.field-sfootulcerfirstopd-post_amputation_duration{display: inline-block;}
.field-sfootulcerfirstopd-post_amputation_months{display: inline-block;}
.field-sfootulcerfirstopd-post_amputation_year{display: inline-block;}

.field-sfootulcerfirstopd-post_revascularization_type{display: inline-block;}
...
<?=$this->render('@app/modules_share/foot/views/default/panel_top',[
    ...
    <br>
    <?=$this->render('../default/foot-ulcer-first/top',['opd'=>'active','ipd' => ''])?>
<h4 style="text-align: center;color:#777;">OPD DIABETIC FOOT ULCER VISIT RECORD : OPD DFU FIRST VISIT</h4>
<hr>    
