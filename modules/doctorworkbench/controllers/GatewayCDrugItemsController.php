...
use app\modules\doctorworkbench\models\GatewayCDrugItemsSearch;
...
class GatewayCDrugItemsController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new GatewayCDrugItems",
                ...
                return [
                    ...
                    'title'=> "Create new GatewayCDrugItems",
                    'content'=>'<span class="text-success">Create GatewayCDrugItems success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update GatewayCDrugItems #".$id,
    ...
    /**
     * Delete an existing GatewayCDrugItems model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing GatewayCDrugItems model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param string $id
     * @return mixed
