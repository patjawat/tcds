        ...
        <?= $form->field($model, 'items')->widget(MultipleInput::className(), [
            ...
            'columns' => [
                ...
                [
                    ...
                    'enableError' => true,
                    'options' => ['class' => 'input-priority','style' => 'width:60px'],
                    'value' => function ($data) {
                ...
                [
                    ...
                    'value' => function ($data) {
                        return Html::textInput($data['med_note'], $data['med_note'], ['class' => 'form-control', 'disabled' => 'true']);
                    },
                ],
                [
                    'name' => 'med_check_note',
