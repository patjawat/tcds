...
$('#re-diag').click(function(){ // คลิกปุ่ม ส่งรายการเฉพาะที่เลือก ไปยัง Medication
...
$.ajax({ // ส่งค่าไปยัง url เพื่แบันทึก
    ...
    dataType:'json',
    async: true,
    url:'index.php?r=doctorworkbench/pcc-diagnosis/re-diag',
    data:{value},  // ส่ง id ไปประมวลผลที่ action
