...
/**
 * DoctorFreeSearch represents the model behind the search form of `app\modules\doctorworkbench\models\DoctorFree`.
 */
class DoctorFreeSearch extends DoctorFree
{
    /**
     * {@inheritdoc}
     */
