                        ...
                        <li>
                            <div style="color: white;margin-left: 17px;margin-top:0px;">
                                <h4>
                                    ...
                                    <?php if (!empty($hn)): ?>
                                        <?=Html::a('  <i class="fas fa-power-off"></i>', ['/site/index'], ['style' => 'color:white', 'title' => 'ยกเลิกให้บริการ','class' => 'btn btn-sm btn-danger']) ?>
                                    <?php endif; ?>
                                </h4>
                        ...
                        <li  style="padding-top: 5px;padding-left: 5px;">
                            <h4>
                                <div id='user-display'>
                                    ...
                                    <?php else: ?>
                                        <?= Html::a(\Yii::$app->user->identity->username, ['/site/about']) ?> |  <span id="show-department"></span>
                                    <?php endif; ?>
                                </div>
                            </h4>
                        </li>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="margin-left:10px;">
      ...
      <?php if (\Yii::$app->user->can('nurse')): //nurse?>
        ...
        <?php elseif (\Yii::$app->user->can('vital_sign_screening_nurse')): ?>
            <?=$this->render('@app/components/_toolbar_vital_sign_screening_nurse') ?>
        <?php  elseif (\Yii::$app->user->can('Q-Manages')): ?>
            <?=$this->render('@app/components/_toolbar_q_manages') ?>
        <?php elseif (\Yii::$app->user->can('dm_nures_manage')): ?>
            <?=$this->render('@app/components/_toolbar_dm_nures_nanage') ?>
        <?php elseif (\Yii::$app->user->can('Exit Nurse')): ?>
            <?= $this->render('@app/components/_toolbar_exit_nurse') ?>
        <?php else : ?>
