...
<?php
// echo $model->nursing_assessment['access'];
			...
			<div class="tabbable-panel">
				<div class="tabbable-line">
                    ...
                    <li class="active">
                        ...
                        <i class="fas fa-universal-access"></i> V/S | CC
                            </a>
                        </li>
                        <!-- <li class="">
                        <a href="#tab_2" class="loadPage" data-toggle="tab" url="index.php?r=chiefcomplaint/pccservicecc">
                        <i class="fas fa-universal-access"></i> CC
                            </a>
                        </li> -->
                        <li>
                        <a href="#tab_3" class="loadPage" data-toggle="tab" url="index.php?r=chiefcomplaint/pccservicepi">
                        <i class="fas fa-file-alt"></i> NC
                            </a>
                        </li>
...
<div class="row">
  ...
  <?=$form->field($model, 'bt')->textInput(['placeholder' => 'องศา C', 'nextid' => 'pccservicepi-height'])->label(true)?>
...
<!-- xx -->
  ...
  <?=$form->field($model, 'wc')->textInput(['placeholder' => 'ระบุหน่วยเป็น cm', 'nextid' => 'pccservicepi-height'])->label(true)?>
...
<div class="col-xs-4 col-sm-4 col-md-3 col-lg-3">
    ...
    'data' => ["lt" => "Lt.","rt" => "Rt."],
    'options' => ['placeholder' => 'Select Arm ...'],
    'pluginOptions' => [
        'allowClear' => true,
    ],
]);?>
  <?=$form->field($model, 'pr')->textInput(['placeholder' => 'ระบุตัวเลข', 'nextid' => 'pccservicepi-height'])->label(true)?>
  <?=$form->field($model, 'pr_rhythm')->widget(Select2::classname(), [
    'data' => ["regular" => "Regular","lrregular" => "Lrregular"],
    'options' => ['placeholder' => 'Select PR Rhythm ...'],
    'pluginOptions' => [
        'allowClear' => true,
    ],
]);?>

  <?=$form->field($model, 'ic')->textInput(['placeholder' => 'ระบุหน่วยเป็น cm', 'nextid' => 'pccservicepi-height'])->label(true)?>
</div>
<!-- End Col-2 -->

<!-- Col-3 -->
<div class="col-xs-4 col-sm-4 col-md-3 col-lg-3">
  <?=$form->field($model, 'rr')->textInput(['placeholder' => 'ระบุตัวเลข', 'nextid' => 'pccservicepi-height'])->label(true)?>
  <?=$form->field($model, 'o2sat')->textInput(['placeholder' => 'ระบุตัวเลข', 'nextid' => 'pccservicepi-height'])->label(true)?>
  <?=$form->field($model, 'ec')->textInput(['placeholder' => 'ระบุหน่วยเป็น cm', 'nextid' => 'pccservicepi-height'])->label(true)?>
  <?=$form->field($model, 'hc')->textInput(['placeholder' => 'ระบุหน่วยเป็น cm', 'nextid' => 'pccservicepi-height'])->label(true)?>
 </div>
<!-- End Col-3 -->
<!-- Col-4 -->
<div class="col-xs-4 col-sm-4 col-md-3 col-lg-3">
  <?=$form->field($model, 'bw')->textInput(['placeholder' => 'ระบุหน่วยเป็น Kg', 'nextid' => 'pccservicepi-height'])->label(true)?>
  <?=$form->field($model, 'ht')->textInput(['placeholder' => 'ระบุหน่วยเป็น cm', 'nextid' => 'pccservicepi-height'])->label(true)?>
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xs-offset-1 col-smoffset-1 col-mdoffset-1 col-lgoffset-1">
            ...
            <p class="btn btn-cyan" data-toggle="modal" data-target =".bd-popup5-modal-lg"> แพทย์ </p>
        </div>
    </div>
       <br>   
...
])->textArea(['placeholder' => 'ระบุตัวเลข','id' => 'cc_text','nextid' => 'pccservicepi-height','rows' => 6])->label(true)?>
        
    </div>
</div>

<div class="row">
    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xs-offset-1 col-smoffset-1 col-mdoffset-1 col-lgoffset-1">
    <span class="btn btn-success" id="saveChiefcomplaint"> <i class="fas fa-check"></i> บันทึก</span>  |  ผู้บันทึก  <i class="fas fa-user-edit"></i> : <code><span class="show-requester-name"></span></code>  &nbsp;| <i class="far fa-clock"></i> : <code><?=$model->updated_at?> </code>
...
<?=$form->field($model, 'nursing_assessment[triage]')->widget(Select2::classname(), [
    'data' => [
        ...
        "Emergency" => "Emergency",
        "Urgent" => "Urgent",
        "Seml-Urgent" => "Seml-Urgent",
        "None-Urgent" => "None-Urgent",
    ],
    'options' => ['placeholder' => 'Select PR Rhythm ...'],
    'pluginOptions' => [
        'allowClear' => true,
...
<?=$form->field($model, 'nursing_assessment[loc]')->widget(Select2::classname(), [
    'data' => [
        ...
        2 => "สับสน",
        3 => "ซึมปลุกตื่น",
        4 => "ซึมปลุกตืไม่คค่อยตื่น",
        5 => "ตอบสนองเล็กน้อย",
        6 => "ไม่รู้สึกตัว",
    ],
    'options' => ['placeholder' => 'Loc'],
    'pluginOptions' => [
        'allowClear' => true,
    ],
])->label('Loc');?>
...
function loadFormControl(){
    ...
    $('.type_of_patient:checked').each(function() { 
        var value = $(this).val();
...
function checkTypeOfPatient(value){
    // console.log(value);
    // if(value == 2){
    //     $("#dm_type").show();
    // }else if(value == 3){
    ...
    // }else{
    //     $("#dm_type").hide()
    //     $("#dm_type").hide().val(null).trigger('change');
    // }
}
